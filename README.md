...
| **SAM.gov Opportunities Scraper** | Live US federal contracting opportunities from SAM.gov — presolicitations, solicitations, sources sought and award notices — with no API key or login: keyword, NAICS, set-aside, notice-type and place-of-performance filters, plus optional detail enrichment for contracting-officer contacts, NAICS, set-aside and place of performance. | [Apify Store](https://apify.com/fetchsmith/sam-gov-opportunities-scraper) · [Docs](https://fetchsmith.com/tools/sam-gov-opportunities-scraper) · [Source](actors/sam-gov-opportunities-scraper) |
...
- [Five public remote-job APIs with no key — and how small each feed really is](https://fetchsmith.com/blog/remote-job-board-json-apis-four-feeds)
