...
1. **HTTP-only**: `GET https://allbirds.com/products.json?limit=50` — Shopify's public, unauthenticated catalog endpoint (the same one [shopify-products-scraper](https://apify.com/fetchsmith/shopify-products-scraper) uses).
