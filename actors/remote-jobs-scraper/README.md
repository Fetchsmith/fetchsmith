...
- Remote OK's and Jobicy's numbers are rendered into `salaryText` (`"$250,000 - $315,000 per year"`, `"Up to $127,000"`). The `per year` suffix appears only where the board stated the period — Jobicy sends one, Remote OK does not, so Remote OK rows read `"$250,000 - $315,000"`.
